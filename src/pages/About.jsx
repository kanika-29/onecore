...
export default function About() {
  ...
  return (
    <div className="w-full bg-brand-ivory text-brand-text">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-6 sm:space-y-8">
              <ScrollReveal>
                <h1 className="editorial-heading text-3xl sm:text-4xl lg:text-5xl xl:text-5xl font-light text-brand-dark tracking-tight leading-[1.14]">
                  {heroSec.title || 'Purposeful formulations. Dependable quality. Patient-centered care.'}
                </h1>
              </ScrollReveal>

              <ScrollReveal delay={0.1}>
                <p className="text-base sm:text-lg lg:text-xl text-brand-muted leading-relaxed font-normal max-w-xl">
                ...
                <div className="relative rounded-sm overflow-hidden border border-brand-border shadow-sm bg-brand-dark aspect-[16/9] flex items-center justify-center group">
                  {heroSec.video_url ? (
                    <video
                      ...
                      poster={heroSec.poster_url || '/assets/about-video-poster.jpg'}
                      autoPlay
                      muted
                      loop
                      playsInline
                    ...
                    <div className="relative w-full h-full">
                      <FallbackImage
                        src={heroSec.poster_url || '/assets/about-video-poster.jpg'}
      ...
      {/* =========================================================================
          SECTION 2 — STRATEGIC FOUNDATION & VISION (Distinct Architectural Layout)
          ========================================================================= */}
      <section className="py-24 sm:py-32 bg-white border-b border-brand-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 lg:space-y-20">
          ...
          <div className="space-y-10">
            ...
            {/* Dual Strategic Columns with Refined Vertical Divider */}
              ...
              <div className="lg:col-span-6 space-y-3">
                <ScrollReveal delay={0.05}>
                  ...
                  <p className="text-base sm:text-lg text-brand-muted leading-relaxed">
                    At Onecore Pharma, every formulation starts with a distinct clinical question: How can this medicine make treatment more reliable, accessible, and comfortable for the patient?
                  </p>
                </ScrollReveal>
              </div>
            ...
            <div className="lg:col-span-4">
              <ScrollReveal delay={0.2}>
                <div className="flex flex-col justify-between gap-8 p-8 sm:p-10 bg-brand-surface/70 border border-brand-border rounded-sm h-full">
                  <div className="space-y-3 border-b border-brand-border/60 pb-8">
                    <span className="text-4xl sm:text-5xl font-light text-brand-sage font-mono">09+</span>
                    <h4 className="text-lg font-semibold text-brand-dark">Therapeutic Specialties</h4>
                    <p className="text-xs sm:text-sm text-brand-muted leading-relaxed">
                      Comprehensive portfolio addressing clinical nuances across essential therapeutic categories.
                    </p>
                  </div>

                  <div className="space-y-3 pt-2">
                    <span className="text-4xl sm:text-5xl font-light text-brand-sage font-mono">100%</span>
                    <h4 className="text-lg font-semibold text-brand-dark">Quality Release Protocol</h4>
                    <p className="text-xs sm:text-sm text-brand-muted leading-relaxed">
                      Multi-tier analytical verification and strict batch release authorization before clinical distribution.
                    </p>
                  </div>
                </div>
              </ScrollReveal>
      ...
      {/* =========================================================================
          SECTION 3 — GUIDING PILLARS (Clean, Balanced & Number-Free)
          ========================================================================= */}
      ...
      {/* =========================================================================
          SECTION 4 — OUR COMMITMENTS (Balanced 3-Column Editorial Framework)
          ========================================================================= */}
      <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="space-y-14">
          <div className="max-w-3xl space-y-3">
            <ScrollReveal>
              <h2 className="editorial-heading text-3xl sm:text-4xl lg:text-5xl font-light text-brand-dark tracking-tight leading-tight">
                Disciplined science, human focus.
              </h2>
              <p className="text-base sm:text-lg text-brand-muted leading-relaxed">
                Connecting clinical insight with dependable pharmaceutical manufacturing to deliver medicines people can trust.
              </p>
            </ScrollReveal>
          </div>
            ...
            <div className="lg:col-span-8 space-y-3">
              <ScrollReveal>
                <h2 className="editorial-heading text-3xl sm:text-4xl font-light text-white tracking-tight">
                  Explore our therapeutic specialties and quality disciplines.
                </h2>
                <p className="text-base sm:text-lg text-gray-300 leading-relaxed max-w-2xl">
                  Discover how our formulations serve diverse clinical disciplines with dependable consistency.
                </p>
              </ScrollReveal>
            </div>
