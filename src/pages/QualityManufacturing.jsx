    ...
    <div className="w-full bg-brand-ivory text-brand-text">
        ...
        <section id="principles" className="py-20 sm:py-28 bg-brand-surface border-y border-brand-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {qualityPrinciples.map((item, idx) => (
              ...
              <ScrollReveal delay={0.15}>
                <div className="pt-4 border-t border-brand-border/80 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-brand-dark">Validated Processes</h4>
                      <p className="text-xs text-brand-muted mt-0.5">Equipment calibration and environmental monitoring.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-brand-sage shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-sm font-semibold text-brand-dark">Batch Traceability</h4>
                      <p className="text-xs text-brand-muted mt-0.5">End-to-end documentation across the supply chain.</p>
                    </div>
                  </div>
                </div>
              </ScrollReveal>
          ...
          <div className="max-w-3xl space-y-4">
            <ScrollReveal>
              ...
              <p className="text-base sm:text-lg text-brand-muted leading-relaxed">
                Key assurance stages designed to support formulation reliability from raw ingredient selection to clinical availability.
              </p>
            </ScrollReveal>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {assuranceSteps.map((step, idx) => (
      ...
      <section className="py-24 sm:py-32 bg-brand-dark text-white text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 relative z-10">
          <ScrollReveal>
            <h2 className="editorial-heading text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-light text-white tracking-tight leading-tight max-w-3xl mx-auto">
          ...
          <ScrollReveal delay={0.1}>
            <p className="text-lg sm:text-xl text-gray-300 font-normal max-w-2xl mx-auto leading-relaxed">
              Explore the therapeutic areas and formulations that make up the Onecore portfolio.
            </p>
          </ScrollReveal>
