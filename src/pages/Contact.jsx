...
export default function Contact() {
  ...
  const displayHours = contact?.office_hours || '10 AM to 7 PM';
  ...
  return (
    <div className="w-full bg-brand-ivory text-brand-text">
      ...
      {/* =========================================================================
          SECTION 2 — GET IN TOUCH (Editorial Large Typography Contact Section)
          ========================================================================= */}
              ...
              <div className="bg-brand-ivory p-8 sm:p-10 border border-brand-border rounded-sm h-full flex flex-col justify-between space-y-6 group hover:border-brand-sage/40 transition-colors shadow-sm">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Mail className="w-4 h-4 text-brand-muted group-hover:text-brand-sage transition-colors" />
                  </div>
                  <a
                  ...
                  <p className="text-sm text-brand-muted leading-relaxed pt-2">
                    For general company and product related enquiries.
                  </p>
                </div>
              ...
              <div className="bg-brand-ivory p-8 sm:p-10 border border-brand-border rounded-sm h-full flex flex-col justify-between space-y-6 group hover:border-brand-sage/40 transition-colors shadow-sm">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Phone className="w-4 h-4 text-brand-muted group-hover:text-brand-sage transition-colors" />
                  </div>
                  <a
              ...
              <div className="bg-brand-ivory p-8 sm:p-10 border border-brand-border rounded-sm h-full flex flex-col justify-between space-y-6 group hover:border-brand-sage/40 transition-colors shadow-sm">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Clock className="w-4 h-4 text-brand-muted group-hover:text-brand-sage transition-colors" />
                  </div>
                  <span className="editorial-heading text-3xl sm:text-4xl font-light text-brand-dark block">
                    {displayHours}
                  </span>
                  <p className="text-sm text-brand-muted leading-relaxed pt-2">
                    For enquiries handled by the Onecore team.
                  </p>
                </div>
                <div className="pt-4 border-t border-brand-border/60">
      ...
      {/* =========================================================================
          SECTION 3 — HOW CAN WE HELP? (Numbered Editorial Enquiry Categories)
          ========================================================================= */}
      <section className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
        <div className="max-w-3xl space-y-4">
          <ScrollReveal>
            ...
            <h2 className="editorial-heading text-3xl sm:text-4xl lg:text-5xl font-light text-brand-dark tracking-tight">
              Choose the reason for getting in touch.
            </h2>
            <p className="text-base sm:text-lg text-brand-muted leading-relaxed">
              Selecting the right enquiry type helps your message reach the relevant Onecore team.
            </p>
          </ScrollReveal>
        </div>

        {/* Numbered List / Editorial Layout */}
        <div className="border-t border-brand-border divide-y divide-brand-border">
          {enquiryOptions.map((opt, idx) => (
            <ScrollReveal key={opt.num} delay={idx * 0.08}>
              <div
                onClick={() => handleSelectEnquiryType(opt.value)}
      ...
      {/* =========================================================================
          SECTION 4 — SEND AN ENQUIRY (Form Section with Client Validation)
          ========================================================================= */}
      <section id="enquiry-form" className="py-24 sm:py-32 bg-brand-surface/60 border-t border-brand-border scroll-mt-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="text-center space-y-4">
            <ScrollReveal>
              <SectionEyebrow className="justify-center">SEND AN ENQUIRY</SectionEyebrow>
              <h2 className="editorial-heading text-3xl sm:text-4xl lg:text-5xl font-light text-brand-dark tracking-tight">
                Tell us how we can help.
              </h2>
              <p className="text-base sm:text-lg text-brand-muted max-w-xl mx-auto leading-relaxed">
                Complete the form and your enquiry can be directed to the appropriate team.
              </p>
            </ScrollReveal>
          </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1.5">
                      ...
                      >
                        ...
                        <option value="Business and distribution">Business and distribution</option>
          ...
          {/* =========================================================================
              SECTION 5 — IMPORTANT DISCLAIMER UNDER FORM
              ========================================================================= */}
          <ScrollReveal delay={0.15}>
            <div className="p-6 bg-brand-ivory border border-brand-border rounded-sm text-center max-w-3xl mx-auto shadow-sm">
              <p className="text-xs sm:text-sm text-brand-muted leading-relaxed">
                Please do not use this form for medical emergencies or to request individual diagnosis, treatment or changes to prescribed medicines. For personal medical advice, contact a qualified healthcare professional.
              </p>
            </div>
          </ScrollReveal>
        </div>
      ...
      {/* =========================================================================
          SECTION 6 — PATIENT SAFETY (Dedicated Reporting Channels)
          ========================================================================= */}
      <section className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
        <div className="max-w-4xl space-y-4">
          <ScrollReveal>
            ...
            <h2 className="editorial-heading text-3xl sm:text-4xl lg:text-5xl font-light text-brand-dark tracking-tight">
              Reporting a safety or quality concern?
            </h2>
            <h3 className="editorial-heading text-xl sm:text-2xl font-normal text-brand-sage">
              Use the dedicated safety reporting route.
            </h3>
            <p className="text-base sm:text-lg text-brand-muted leading-relaxed pt-2">
              Suspected side effects and product quality concerns should be reported through the appropriate safety channel so the information can be reviewed correctly.
            </p>
          </ScrollReveal>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="bg-brand-surface p-8 sm:p-10 border border-brand-border rounded-sm h-full flex flex-col justify-between space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-sm sm:text-base text-brand-muted leading-relaxed">
                  Submit observations regarding side effects or product quality issues directly to our pharmacovigilance team.
                </p>
              </div>

              <div className="pt-4 border-t border-brand-border">
                <Link
                  to="/patients-caregivers#patient-safety"
                ...
                >
                  <span>Report a safety or product quality concern</span>
          ...
          {/* Card 2: Healthcare Professionals */}
          <ScrollReveal delay={0.1}>
            <div className="bg-brand-surface p-8 sm:p-10 border border-brand-border rounded-sm h-full flex flex-col justify-between space-y-8">
              <div className="space-y-4">
                <span className="text-xs font-mono font-semibold uppercase tracking-widest text-brand-sage">
                ...
                <h4 className="text-2xl font-medium text-brand-dark tracking-tight">
                  Clinical safety desk
                </h4>
                <p className="text-sm sm:text-base text-brand-muted leading-relaxed">
                  Medical practitioners can log adverse drug observations or quality documentation for formal regulatory evaluation.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-brand-border">
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-brand-dark hover:text-brand-sage transition-colors group"
                >
                  <span>Submit safety information</span>
                  <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </div>
      ...
      {/* =========================================================================
          SECTION 7 — WHAT HAPPENS NEXT (Minimal Process Section)
          ========================================================================= */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          <div className="max-w-3xl space-y-4">
            <ScrollReveal>
              ...
              <h2 className="editorial-heading text-3xl sm:text-4xl lg:text-5xl font-light text-brand-dark tracking-tight">
                Your message goes to the team best placed to respond.
              </h2>
            </ScrollReveal>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <ScrollReveal delay={0.05}>
              <div className="p-8 bg-brand-ivory border border-brand-border rounded-sm space-y-4 h-full">
                <div className="flex items-center justify-between">
                  <span className="text-3xl font-light font-mono text-brand-sage">01</span>
                  <span className="text-xs font-mono font-semibold text-brand-muted uppercase">STAGE 1</span>
                </div>
                <h3 className="text-xl font-medium text-brand-dark">01 — Submit</h3>
                <p className="text-sm text-brand-muted leading-relaxed">
                  Tell us who you are and the nature of your enquiry.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.1}>
              <div className="p-8 bg-brand-ivory border border-brand-border rounded-sm space-y-4 h-full">
                <div className="flex items-center justify-between">
                  <span className="text-3xl font-light font-mono text-brand-sage">02</span>
                  <span className="text-xs font-mono font-semibold text-brand-muted uppercase">STAGE 2</span>
                </div>
                <h3 className="text-xl font-medium text-brand-dark">02 — Route</h3>
                <p className="text-sm text-brand-muted leading-relaxed">
                  Your message is directed to the relevant Onecore function.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.15}>
              <div className="p-8 bg-brand-ivory border border-brand-border rounded-sm space-y-4 h-full">
                <div className="flex items-center justify-between">
                  <span className="text-3xl font-light font-mono text-brand-sage">03</span>
                  <span className="text-xs font-mono font-semibold text-brand-muted uppercase">STAGE 3</span>
                </div>
                <h3 className="text-xl font-medium text-brand-dark">03 — Respond</h3>
                <p className="text-sm text-brand-muted leading-relaxed">
                  The appropriate team can contact you if a response or further information is required.
                </p>
              </div>
            </ScrollReveal>
          </div>
      ...
      {/* =========================================================================
          SECTION 8 — FINAL CTA (Brand Section)
          ========================================================================= */}
      <section className="py-24 sm:py-32 bg-brand-dark text-white border-t border-brand-border-dark text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <ScrollReveal>
            ...
            <h2 className="editorial-heading text-4xl sm:text-5xl lg:text-6xl font-light text-white tracking-tight leading-tight max-w-3xl mx-auto">
              Healthcare centered on people.
            </h2>
          </ScrollReveal>
